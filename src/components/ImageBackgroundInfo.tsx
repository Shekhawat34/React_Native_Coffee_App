  ...
  return (
    <View>
      ...
      style={styles.ItemBackgroundImage}
       ...
       >
        {EnableBackHandler?(
            <View style={styles.ImageHeaderBarCOmponentWithBack}>
            ...
            <View style={styles.ImageHeaderBarCOmponentWithoutBack}>
                <TouchableOpacity onPress={()=>{
                    ToggleFavourite(
                        favourite,type,id
                    );
...
const styles = StyleSheet.create({
    ...
    ImageHeaderBarCOmponentWithBack:{
    ...
    ImageHeaderBarCOmponentWithoutBack:{
        padding:SPACING.space_30,
        flexDirection:'row',
        alignItems:'center',
